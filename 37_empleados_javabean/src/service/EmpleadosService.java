...
public class EmpleadosService {
	...
	HashMap <Integer,EmpleadosModel> empleados = new HashMap <>();

	
	//*************************************************************************
	public boolean agregarEmpleado (EmpleadosModel empleado) {
		boolean existe=true;
	...
	//*************************************************************************
	public EmpleadosModel bucarEmpleado (int codigo) {
		return empleados.get(codigo); // devuelve nombre si existe, sino devuelve null
	}
	
	//*************************************************************************
	public EmpleadosModel eliminarEmpleado (int codigo) {
		return empleados.remove(codigo);  //devuelve nombre si existe, sino devuelve null
	}
	
	//*************************************************************************
	public EmpleadosModel [] listadoEmpleados () {
		Collection<EmpleadosModel> todos=empleados.values();
		return todos.toArray(new EmpleadosModel[0]);	
	}
